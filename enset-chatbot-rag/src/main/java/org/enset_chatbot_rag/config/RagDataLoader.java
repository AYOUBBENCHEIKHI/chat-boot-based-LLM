package org.enset_chatbot_rag.config;
...
public class RagDataLoader {
	...
	// sca pour un base de donne statique c-a-d dans les dossier de code ou de projet
	//@Bean
...
*/
	...
	public void initStore(){
		...
		if (count == 0){
			...
			vectorStore.add(chunks);//add et accept meme chose
		}
	}
